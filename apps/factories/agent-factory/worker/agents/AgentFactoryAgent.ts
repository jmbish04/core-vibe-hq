/**
 * apps/agent-factory/worker/agents/AgentFactoryAgent.ts
 * 
 * Agent Factory Agent - Specialized agent for the agent-factory
 * Extends FactoryOrchestratorAgent with agent-factory-specific configuration
 * 
...
export class AgentFactoryAgent extends FactoryOrchestratorAgent {
  constructor(
    env: CoreEnv | BaseEnv,
    ...
    super(
      env,
      logger,
      'apps/agent-factory/templates', // templatePath
      ['cloudflare-docs'], // mcpTools
      context
    )
  }
