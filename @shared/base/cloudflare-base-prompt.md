...
### Workers Analytics Engine Example
...
### Browser Rendering Workers Example
...
export class AIAgent extends Agent {
  ...
  async queryUser(userId: string) {
    ...
    const user = await this.sql<User>`SELECT * FROM users WHERE id = ${prompt.userId}`;
    return user
  }
...
### Workers AI Structured Outputs JSON Example
...
### WebSocket Coordination Pattern
