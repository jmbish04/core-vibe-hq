...
CREATE INDEX `ai_provider_assignments_patch_id_idx` ON `ai_provider_assignments` (`patch_id`);--> statement-breakpoint
CREATE INDEX `ai_provider_assignments_provider_id_idx` ON `ai_provider_assignments` (`provider_id`);--> statement-breakpoint
CREATE INDEX `ai_provider_assignments_status_idx` ON `ai_provider_assignments` (`status`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `ai_provider_configs_provider_id_idx` ON `ai_provider_configs` (`provider_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `ai_provider_configs_provider_id_version_idx` ON `ai_provider_configs` (`provider_id`,`version`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `ai_provider_executions_assignment_id_idx` ON `ai_provider_executions` (`assignment_id`);--> statement-breakpoint
CREATE INDEX `ai_provider_executions_status_idx` ON `ai_provider_executions` (`status`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `build_logs_build_id_idx` ON `build_logs` (`build_id`);--> statement-breakpoint
CREATE INDEX `build_logs_stage_idx` ON `build_logs` (`stage`);--> statement-breakpoint
CREATE INDEX `build_logs_created_at_idx` ON `build_logs` (`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `delivery_reports_patch_id_idx` ON `delivery_reports` (`patch_id`);--> statement-breakpoint
CREATE INDEX `delivery_reports_status_idx` ON `delivery_reports` (`status`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `ops_issues_status_idx` ON `ops_issues` (`status`);--> statement-breakpoint
CREATE INDEX `ops_issues_type_idx` ON `ops_issues` (`type`);--> statement-breakpoint
CREATE INDEX `ops_issues_severity_idx` ON `ops_issues` (`severity`);--> statement-breakpoint
CREATE INDEX `ops_issues_created_at_idx` ON `ops_issues` (`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `ops_scans_scan_type_idx` ON `ops_scans` (`scan_type`);--> statement-breakpoint
CREATE INDEX `ops_scans_status_idx` ON `ops_scans` (`status`);--> statement-breakpoint
CREATE INDEX `ops_scans_created_at_idx` ON `ops_scans` (`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `patch_events_patch_id_idx` ON `patch_events` (`patch_id`);--> statement-breakpoint
CREATE INDEX `patch_events_event_type_idx` ON `patch_events` (`event_type`);--> statement-breakpoint
CREATE INDEX `patch_events_created_at_idx` ON `patch_events` (`created_at`);--> statement-breakpoint
...
CREATE INDEX `stars_app_starred_at_idx` ON `stars` (`app_id`,`starred_at`);--> statement-breakpoint
...
CREATE INDEX `verification_otps_used_idx` ON `verification_otps` (`used`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `worker_logs_worker_id_idx` ON `worker_logs` (`worker_id`);--> statement-breakpoint
CREATE INDEX `worker_logs_level_idx` ON `worker_logs` (`level`);--> statement-breakpoint
