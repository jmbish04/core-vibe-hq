...
type HilRequestCreatedMessage = {
	type: 'hil_request_created';
...
type HilRequestResolvedMessage = {
	type: 'hil_request_resolved';
	hil_request_id: number;
	order_id: string;
	conversation_id: string;
...
type OrderPlaceholderMappingUpdatedMessage = {
	type: 'order_placeholder_mapping_updated';
	order_id: string;
	timestamp: number;
};
...
export type WebSocketMessage =
	...
	| ServerLogMessage
	| HilRequestCreatedMessage
	| HilRequestResolvedMessage
	| TemplateUpdatedMessage
	| OrderPlaceholderMappingUpdatedMessage;
