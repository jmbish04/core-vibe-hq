...
export const WebSocketMessageResponses: Record<string, WebSocketMessageType> = {
    ...
    // Human-in-the-Loop (HIL) messages
    HIL_REQUEST_CREATED: 'hil_request_created',
    HIL_REQUEST_RESOLVED: 'hil_request_resolved',
    
    // Template management messages
    TEMPLATE_UPDATED: 'template_updated',
    ORDER_PLACEHOLDER_MAPPING_UPDATED: 'order_placeholder_mapping_updated',
}
