<!-- 8d71048d-a364-4a2b-8d7f-4238c4e1fe0b afd979f6-9c8f-45d9-9d7c-e7012ffc4844 -->
...
### Tag-Based Work Distribution

**Team 1 (Foundation)**: `[FOUNDATION]`, `[SHARED]`, `[DB-SCHEMA]`

- Work on: 1.1, 1.2, 1.3, 1.4

**Team 2 (Patch System)**: `[PATCH-SYSTEM]`, `[WEBSOCKET]`, `[ANALYTICS]`, `[DELIVERY]`

- Work on: 2.1-2.4, 3.1-3.5, 4.1-4.5 (after Foundation complete)

**Team 3 (AI Provider)**: `[AI-PROVIDER]`, `[ROUTING]`

- Work on: 5.1-5.7 (after Foundation complete, can overlap with Patch System)

**Team 4 (Multi-Pass)**: `[MULTI-PASS]`, `[SPECIALIST]`, `[DOCS]`

- Work on: 6.1-6.3 (after Foundation and Patch System Phase 2 complete)

**Team 5 (Integration)**: `[INTEGRATION]`, `[FACTORY-UPDATE]`

- Work on: 7.1-7.4 (after all other phases complete)

**Team 6 (Testing)**: `[TESTING]`, `[VALIDATION]`

- Work on: 8.1-8.4 (after all implementation phases)
...
- **Checkpoint 1**: After Foundation Phase - All teams can proceed
- **Checkpoint 2**: After Patch System Phase 2 - Multi-Pass team can proceed
- **Checkpoint 3**: After all implementation - Integration team proceeds
- **Checkpoint 4**: After Integration - Testing team proceeds
...
- `orchestrator/worker/services/patch/*` (4 files)
- `orchestrator/worker/services/websocket/*` (1 file)
- `orchestrator/worker/services/delivery/*` (1 file)
- `orchestrator/worker/services/ops/*` (1 file)
- `orchestrator/worker/services/ai-providers/*` (6+ files)
- `orchestrator/worker/services/secrets/*` (1 file)
- `orchestrator/worker/services/patch-manager/*` (1 file)
- `orchestrator/worker/integrations/*` (1 file)
- `orchestrator/worker/entrypoints/patch.ts`, `opsScan.ts`, `AIProviderOps.ts`
- `orchestrator/worker/api/routes/*` (7+ files)
- `orchestrator/migrations/*` (4+ files)
- `patch_manager.py`, `patchctl`
...
- Factory workers (update imports)
- `docs/OVERVIEW.md`