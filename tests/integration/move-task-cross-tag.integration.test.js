...
jest.unstable_mockModule('@tmstaging/scripts/modules/utils.js', () => mockUtils);

// Mock other dependencies
jest.unstable_mockModule(
	'@tmstaging/scripts/modules/task-manager/is-task-dependent.js',
	() => ({
		default: jest.fn(() => false)
	})
);

jest.unstable_mockModule('@tmstaging/scripts/modules/dependency-manager.js', () => ({
...
const { moveTasksBetweenTags } = await import(
	'@tmstaging/scripts/modules/task-manager/move-task.js'
);
