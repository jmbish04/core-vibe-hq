...
jest.unstable_mockModule('@tmstaging/scripts/modules/utils/git-utils.js', () => ({
	insideGitWorkTree: jest.fn(() => false)
}));

// Mock rule transformer
jest.unstable_mockModule('@tmstaging/src/utils/rule-transformer.js', () => ({
...
const mockUtils = await import('@tmstaging/scripts/modules/utils.js');
const mockGitUtils = await import('@tmstaging/scripts/modules/utils/git-utils.js');
const mockRuleTransformer = await import('@tmstaging/src/utils/rule-transformer.js');

// Import after mocks
const { initializeProject } = await import('@tmstaging/scripts/init.js');
