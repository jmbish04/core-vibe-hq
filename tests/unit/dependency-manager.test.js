...
jest.mock('@tmstaging/scripts/modules/utils.js', () => ({
	log: mockLog,
...
} from '@tmstaging/scripts/modules/dependency-manager.js';

jest.mock('@tmstaging/scripts/modules/ui.js', () => ({
	displayBanner: jest.fn()
}));

jest.mock('@tmstaging/scripts/modules/task-manager.js', () => ({
...
describe('Dependency Manager Module', () => {
	...
	describe('Cross-level dependency tests (Issue #542)', () => {
		...
		beforeEach(async () => {
			...
			await jest.unstable_mockModule('@tmstaging/scripts/modules/utils.js', () => ({
				log: mockLog,
				readJSON: mockReadJSON,
				writeJSON: mockWriteJSON,
				taskExists: mockTaskExists,
			...
			await jest.unstable_mockModule('@tmstaging/scripts/modules/ui.js', () => ({
				displayBanner: jest.fn()
			}));
