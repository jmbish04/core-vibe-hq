...
jest.mock('@tmstaging/scripts/modules/config-manager.js', () => ({
...
jest.mock('@tmstaging/src/utils/path-utils.js', () => ({
	__esModule: true,
...
import { setupCLI } from '@tmstaging/scripts/modules/commands.js';
import {
	RULES_SETUP_ACTION,
	RULES_ACTIONS
} from '@tmstaging/src/constants/rules-actions.js';
