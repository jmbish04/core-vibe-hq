...
jest.unstable_mockModule('@tmstaging/src/utils/path-utils.js', () => ({
...
jest.unstable_mockModule(
	'@tmstaging/scripts/modules/utils/contextGatherer.js',
	() => {
...
const { resolveComplexityReportOutputPath, findComplexityReportPath } =
	await import('@tmstaging/src/utils/path-utils.js');
...
const { generateTextService, generateObjectService, streamTextService } =
	await import('@tmstaging/scripts/modules/ai-services-unified.js');

// Import the modules under test
const { default: analyzeTaskComplexity } = await import(
	'@tmstaging/scripts/modules/task-manager/analyze-task-complexity.js'
);

const { default: expandTask } = await import(
	'@tmstaging/scripts/modules/task-manager/expand-task.js'
);
