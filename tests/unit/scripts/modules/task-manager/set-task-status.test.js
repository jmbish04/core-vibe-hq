...
jest.unstable_mockModule('@tmstaging/src/constants/task-status.js', () => ({
...
jest.unstable_mockModule(
	'@tmstaging/scripts/modules/task-manager/update-single-task-status.js',
	() => ({
		default: jest.fn()
	})
);
...
jest.unstable_mockModule(
	'@tmstaging/scripts/modules/dependency-manager.js',
	() => ({
...
const { default: setTaskStatus } = await import(
	'@tmstaging/scripts/modules/task-manager/set-task-status.js'
);
