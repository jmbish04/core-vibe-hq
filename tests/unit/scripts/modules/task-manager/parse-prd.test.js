...
jest.unstable_mockModule(
	'@tmstaging/scripts/modules/config-manager.js',
	() => ({
...
jest.unstable_mockModule(
	'@tmstaging/scripts/modules/task-manager/models.js',
	() => ({
...
jest.unstable_mockModule(
	'@tmstaging/scripts/modules/prompt-manager.js',
	() => ({
...
jest.unstable_mockModule(
	'@tmstaging/src/progress/parse-prd-tracker.js',
	() => ({
...
const { readJSON, promptYesNo } = await import(
	'@tmstaging/scripts/modules/utils.js'
);
...
const { parseStream, StreamingError, STREAMING_ERROR_CODES } = await import(
	'@tmstaging/src/utils/stream-parser.js'
);
...
const { default: parsePRD } = await import(
	'@tmstaging/scripts/modules/task-manager/parse-prd/parse-prd.js'
);
