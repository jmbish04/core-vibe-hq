...
jest.unstable_mockModule('@tmstaging/src/ai-providers/base-provider.js', () => ({
...
const { GeminiCliProvider } = await import(
	'@tmstaging/src/ai-providers/gemini-cli.js'
);
const { createGeminiProvider } = await import('ai-sdk-provider-gemini-cli');
const { generateObject, generateText, streamText } = await import('ai');
const { log } = await import('@tmstaging/scripts/modules/utils.js');
