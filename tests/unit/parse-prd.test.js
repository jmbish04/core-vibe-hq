...
jest.unstable_mockModule(
	'@tmstaging/scripts/modules/ai-services-unified.js',
	() => ({
...
jest.unstable_mockModule('@tmstaging/scripts/modules/config-manager.js', () => ({
...
jest.unstable_mockModule('@tmstaging/scripts/modules/utils.js', () => ({
	log: jest.fn(),
	writeJSON: jest.fn(),
...
// Mock prompt manager
jest.unstable_mockModule('@tmstaging/scripts/modules/prompt-manager.js', () => ({
...
jest.unstable_mockModule('@tmstaging/src/progress/parse-prd-tracker.js', () => ({
...
jest.unstable_mockModule('@tmstaging/src/ui/parse-prd.js', () => ({
	displayParsePrdStart: jest.fn(),
	displayParsePrdSummary: jest.fn()
}));

jest.unstable_mockModule('@tmstaging/scripts/modules/ui.js', () => ({
	displayAiUsageSummary: jest.fn()
}));

// Mock task generation to prevent file operations
jest.unstable_mockModule(
	'@tmstaging/scripts/modules/task-manager/generate-task-files.js',
	() => ({
		default: jest.fn()
	})
);
...
// Mock stream parser
jest.unstable_mockModule('@tmstaging/src/utils/stream-parser.js', () => {
...
// Mock constants
jest.unstable_mockModule('@tmstaging/src/constants/task-priority.js', () => ({
	DEFAULT_TASK_PRIORITY: 'medium',
	TASK_PRIORITY_OPTIONS: ['low', 'medium', 'high']
}));

// Mock UI indicators
jest.unstable_mockModule('@tmstaging/src/ui/indicators.js', () => ({
...
const parsePRD = (
	await import('@tmstaging/scripts/modules/task-manager/parse-prd/parse-prd.js')
).default;
